...
public class JellyTestService {
    ...
    public void callJellyResult(String mJelly, Member member) {
        if (mJelly.equals("ENTJ") || mJelly.equals("ESTP") || mJelly.equals("INTJ")) member.setMJelly(1);
        else if (mJelly.equals("ESTJ") || mJelly.equals("ESFP") || mJelly.equals("ISFP")) member.setMJelly(2);
        else if (mJelly.equals("ESFJ") || mJelly.equals("ENFP") || mJelly.equals("INTP")) member.setMJelly(3);
        else if (mJelly.equals("ENTP") || mJelly.equals("ENFJ") || mJelly.equals("INFP")) member.setMJelly(4);
        else if (mJelly.equals("ISTP") || mJelly.equals("INFJ") || mJelly.equals("ISFJ")||mJelly.equals("ISTJ")) member.setMJelly(5);
    }
